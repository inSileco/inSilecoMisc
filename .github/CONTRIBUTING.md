...
* Submit an issue on the [Issues page](https://github.com/inSileco/inSilecoMisc/issues)
...
* Clone your version on your account down to your machine from your account, e.g,. `git clone https://github.com/<yourgithubusername>/inSilecoMisc.git`
* Make sure to track progress upstream (i.e., on our version of `inSilecoMisc` at `inSileco/inSilecoMisc`) by doing `git remote add upstream https://github.com/inSileco/inSilecoMisc.git`. Before making changes make sure to pull changes in from upstream by doing either `git fetch upstream` then merge later or `git pull upstream` to fetch and merge in one step
* Make your changes (bonus points for making changes on a new feature branch)
* Please do write a test(s) for your changes if they affect code and not just docs (see Tests below)
* Push up to your account
* Submit a pull request to home base at `inSileco/inSilecoMisc`
